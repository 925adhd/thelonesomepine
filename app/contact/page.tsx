...
import { CornerLeaves } from "@/components/ui/Botanicals";
...
export const metadata: Metadata = {
  title: "Visit & Contact",
  description:
    "Find The Lonesome Pine inside The Rabbit Hole at 101 N Heyser Dr in Leitchfield, Kentucky. Get our hours, directions, and contact info.",
};
          ...
          <div className="grid gap-16 lg:grid-cols-5 lg:gap-24">
              ...
              <ScrollReveal>
                <div className="space-y-12">
                  ...
                  <div>
                    ...
                    <address className="mt-4 space-y-1 text-base not-italic leading-relaxed text-text-muted">
                      <p className="text-lg font-medium text-text">
                        {siteConfig.vendorLocation.venue}
                      </p>
                      <p>{siteConfig.vendorLocation.street}</p>
                      <p>
                    ...
                    <p className="mt-4 text-base text-text-muted">
                      ...
                      . Come on in and look for the plants — you can&apos;t
                      miss us!
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-4 space-y-3">
                      <a
                        ...
                        className="flex items-center gap-3 text-base text-text-muted transition-colors hover:text-primary"
                      >
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-pine-50 text-accent">
                          <svg
                            className="h-5 w-5"
                            fill="none"
                            viewBox="0 0 24 24"
            ...
            <div className="lg:col-span-2">
              <ScrollReveal delay={200}>
                <div className="sticky top-28 overflow-hidden rounded-2xl bg-surface-warm p-8 ring-1 ring-border-light">
                  <CornerLeaves className="pointer-events-none absolute -bottom-2 -right-2 h-24 w-24 rotate-180 text-pine-400/30" />
