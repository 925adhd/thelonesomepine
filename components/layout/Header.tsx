...
export function Header() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-0 z-[85] bg-black/50 backdrop-blur-[2px] transition-opacity duration-300 md:hidden",
          mobileMenuOpen
      ...
      >
        {/* Subtle organic texture — very faint leaf pattern */}
        <div className="pointer-events-none absolute inset-0 opacity-[0.03]">
          <div className="absolute -right-8 top-20 h-64 w-64 rotate-12 rounded-full bg-gradient-to-br from-pine-400 to-transparent blur-3xl" />
          <div className="absolute -left-12 bottom-32 h-48 w-48 -rotate-12 rounded-full bg-gradient-to-tr from-pine-500 to-transparent blur-3xl" />
        </div>

        <div className="relative flex flex-1 flex-col justify-between px-7 pb-10 pt-24">
          {/* Nav links */}
          <nav>
                ...
                <li
                  ...
                  style={{
                    ...
                    transform: mobileMenuOpen
                      ? "translateX(0)"
                      : "translateX(32px)",
                    transition: `opacity 0.35s ease ${120 + i * 60}ms, transform 0.35s ease ${120 + i * 60}ms`,
                  }}
                >
                  <Link
                    href={item.href}
                    className={cn(
                      "group flex items-center gap-3 rounded-xl px-3 py-4 font-[family-name:var(--font-western)] text-[22px] transition-all duration-200",
                      isActive(item.href)
                        ? "bg-white/[0.08] text-white"
                        : "text-white/75 active:bg-white/[0.05] active:text-white"
                    )}
                  >
                    <IconLeaf
                      className={cn(
                        ...
                        isActive(item.href)
                          ? "text-pine-400 opacity-100"
                          : "text-pine-500 opacity-0 group-active:opacity-60"
                      )}
                      stroke={1.5}
                      aria-hidden="true"
                    />
          ...
          >
            {/* Divider */}
            <div className="mb-6 h-px bg-gradient-to-r from-pine-700/50 via-pine-600/30 to-transparent" />
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-white/60 transition-all duration-200 active:border-white/25 active:text-white"
                aria-label="Facebook"
              >
        ...
        >
          ...
          <Link
            ...
            className={cn(
              ...
              mobileMenuOpen ? "text-cream" : "text-cream sm:text-green-950"
            )}
          >
            <Image
              src="/images/pine.png"
              ...
              className={cn(
                ...
                "brightness-0 invert sepia-[0.15] sm:brightness-100 sm:invert-0 sm:sepia-0",
                mobileMenuOpen && "brightness-0 invert sepia-[0.15]"
              )}
              aria-hidden="true"
            />
            {siteConfig.name}
          ...
          <button
            ...
            className={cn(
              ...
              mobileMenuOpen ? "text-cream" : "text-cream sm:text-gray-700"
            )}
